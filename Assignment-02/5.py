...
#The bank would provide the loan, only if the loan amount and the number of EMI’s requested by the customer is less than or 
...
#Salary     Loan type    Eligible         No. of EMI’s required
